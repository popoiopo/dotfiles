...
#+BEGIN_SRC emacs-lisp
  ...
  (add-to-list 'org-structure-template-alist
               '("py" "#+BEGIN_SRC python?\n#+END_SRC"))
  (add-to-list 'org-structure-template-alist
               '("r" "#+BEGIN_SRC R :session :results output\n?\n#+END_SRC"))
  (add-to-list 'org-structure-template-alist
               '("rt" "#+BEGIN_SRC R :session :results output :colnames yes :rownames yes\n?\n#+END_SRC"))
  (add-to-list 'org-structure-template-alist
               '("rf" "#+BEGIN_SRC R :session :file ?.png :results output graphics :exports both\n?\n#+END_SRC"))
